...
# direct methods
.method public static synthetic $r8$lambda$-2sc8nDh-80TMJWoAz3fuM4SGoA(JLandroid/database/Cursor;)Lcom/google/android/datatransport/runtime/firebase/transport/TimeWindow;
    .locals 2
...
.method public static synthetic $r8$lambda$-c5yRpmc2Pusxok-ESpsItypEVU(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    .locals 7
...
.method public static synthetic $r8$lambda$5Uvct5cGMjQeavljSmguhr62CK8(Landroid/database/Cursor;)Ljava/util/List;
    .locals 3
...
.method public static synthetic $r8$lambda$8LOwVn7k0hj_OWr4Ylfbk4bxfj8(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 4
...
.method public static synthetic $r8$lambda$DYhwaGroa6Bx2rA3UTBVIryQQQM(Ljava/lang/Throwable;)Landroid/database/sqlite/SQLiteDatabase;
    .locals 2
...
.method public static synthetic $r8$lambda$FPCWqOWJeVGVZGsEViC6KdIzvC4(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 4
...
.method public static synthetic $r8$lambda$FWBHKI0M7buhnYqPq5piDyOvkh8(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/lang/String;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda9;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;)V
...
.method public static synthetic $r8$lambda$G8uJ-S54jP30MGd1qBdzDbSf55k(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Boolean;
    .locals 0
    ...
    new-instance p1, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda4;

    invoke-direct {p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda4;-><init>()V
...
.method public static synthetic $r8$lambda$GHMqzva9B_XnmPprSGyr5JoZ7b8(JLcom/google/android/datatransport/runtime/TransportContext;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 3
...
.method public static synthetic $r8$lambda$MhWEBJkj-Z48pXSpbh-iwCbV5kA(Landroid/database/Cursor;)[B
    .locals 6
...
.method public static synthetic $r8$lambda$OYeq4gZ6BLfEujKfNIuFZurIZak(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    .locals 2
...
.method public static synthetic $r8$lambda$TKobF03u2pdjGMo2w1gTJSqaKCE(Landroid/database/Cursor;)Ljava/lang/Boolean;
    .locals 0
...
.method public static synthetic $r8$lambda$Ywc_XdJ71otWx32TGVXHNljPxcI(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 4
...
.method public static synthetic $r8$lambda$bBQL4XWV8rqSJshoDiUR95y-_jM(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic $r8$lambda$cAnhwi1GNvuKjmAGBcKUf1ZtJ8M(Landroid/database/Cursor;)Ljava/lang/Long;
    .locals 2
...
.method public static synthetic $r8$lambda$cMN1kDUWPXuzjr1P3QAWoeACqG8(Ljava/lang/Throwable;)Ljava/lang/Object;
    .locals 2
...
.method public static synthetic $r8$lambda$m2Cid-bNtM3iXXm7FvzU6_pgJWc(Ljava/lang/String;Lcom/google/android/datatransport/runtime/firebase/transport/LogEventDropped$Reason;JLandroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 3
...
.method public static synthetic $r8$lambda$mObue6vDcpMgJg6tRUgbT0MgVDo(Ljava/util/Map;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 5
...
.method public static synthetic $r8$lambda$oWyA6AJGDizu9ZmA0KcBicBGgCY(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;JLandroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Integer;
    .locals 1
...
.method public static synthetic $r8$lambda$rhfHXis96N9wATghbYmJ6PQO9G0(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/util/List;Lcom/google/android/datatransport/runtime/TransportContext;Landroid/database/Cursor;)Ljava/lang/Object;
    .locals 6
...
.method public static synthetic $r8$lambda$tjc_qlQgTB-9tdANbPFpY4kEz4U(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Object;
    .locals 3
...
.method public static synthetic $r8$lambda$wkPqtdo8abVVVntIT0LL_IpuNhI(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/lang/String;Ljava/util/Map;Lcom/google/android/datatransport/runtime/firebase/transport/ClientMetrics$Builder;Landroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/datatransport/runtime/firebase/transport/ClientMetrics;
    ...
    new-instance p4, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda15;

    invoke-direct {p4, p0, p2, p3}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda15;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/util/Map;Lcom/google/android/datatransport/runtime/firebase/transport/ClientMetrics$Builder;)V
...
.method public static synthetic $r8$lambda$zCKpHwX4pX2SAl7zbN4WB6el84g(Landroid/database/Cursor;)Ljava/lang/Long;
    .locals 2
...
.method public static synthetic $r8$lambda$zOq4Ptcu6jxQh2yulOulwMnkbKw(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/datatransport/runtime/firebase/transport/TimeWindow;
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda26;-><init>(J)V
...
.method private ensureBeginTransaction(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {v0, p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda2;-><init>(Landroid/database/sqlite/SQLiteDatabase;)V

    new-instance p1, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda3;

    invoke-direct {p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda3;-><init>()V
...
.method private getTimeWindow()Lcom/google/android/datatransport/runtime/firebase/transport/TimeWindow;
    ...
    invoke-direct {v2, v0, v1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda24;-><init>(J)V
...
.method private getTransportContextId(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/datatransport/runtime/TransportContext;)Ljava/lang/Long;
    ...
    invoke-direct {p2}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda11;-><init>()V
...
.method private loadEvents(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/datatransport/runtime/TransportContext;I)Ljava/util/List;
    ...
    invoke-direct {v2, v3, v0, v4}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda10;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Ljava/util/List;Lcom/google/android/datatransport/runtime/TransportContext;)V
...
.method private loadMetadata(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)Ljava/util/Map;
    ...
    new-instance p2, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda18;

    invoke-direct {p2, v0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda18;-><init>(Ljava/util/Map;)V
...
.method public cleanUp()I
    ...
    .line 389
    new-instance v2, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda19;

    invoke-direct {v2, p0, v0, v1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda19;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;J)V
...
.method public clearDb()V
    ...
    invoke-direct {v0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda5;-><init>()V
...
.method getDb()Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v1, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda7;

    invoke-direct {v1, v0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda7;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SchemaManager;)V
    ...
    invoke-direct {v0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda8;-><init>()V
...
.method public loadBatch(Lcom/google/android/datatransport/runtime/TransportContext;)Ljava/lang/Iterable;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda6;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;Lcom/google/android/datatransport/runtime/TransportContext;)V
...
.method public recordLogEventDropped(JLcom/google/android/datatransport/runtime/firebase/transport/LogEventDropped$Reason;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p4, p3, p1, p2}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda20;-><init>(Ljava/lang/String;Lcom/google/android/datatransport/runtime/firebase/transport/LogEventDropped$Reason;J)V
...
.method public recordNextCallTime(Lcom/google/android/datatransport/runtime/TransportContext;J)V
    ...
    invoke-direct {v0, p2, p3, p1}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda16;-><init>(JLcom/google/android/datatransport/runtime/TransportContext;)V
...
.method public resetClientMetrics()V
    ...
    invoke-direct {v0, p0}, Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$$ExternalSyntheticLambda17;-><init>(Lcom/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore;)V
