...
.method public static synthetic $r8$lambda$tBYVtDHCMH8xrQ1aRWBKD8kAvDc(Landroidx/media3/extractor/mp4/FragmentedMp4Extractor;JLandroidx/media3/common/util/ParsableByteArray;)V
    .locals 0
...
.method private onMoovContainerAtomRead(Landroidx/media3/container/Mp4Box$ContainerBox;)V
    ...
    .line 752
    iget v12, v8, Landroidx/media3/container/Mp4Box;->type:I
    ...
    invoke-direct {v14, v4}, Landroidx/media3/common/Metadata;-><init>([Landroidx/media3/common/Metadata$Entry;)V
    ...
    iget v8, v6, Landroidx/media3/extractor/mp4/Track;->type:I

    invoke-interface {v7, v9, v8}, Landroidx/media3/extractor/ExtractorOutput;->track(II)Landroidx/media3/extractor/TrackOutput;
    ...
    .line 795
    iget-wide v8, v6, Landroidx/media3/extractor/mp4/Track;->durationUs:J

    invoke-interface {v7, v8, v9}, Landroidx/media3/extractor/TrackOutput;->durationUs(J)V

    .line 796
    iget-object v8, v6, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;
    ...
    .line 798
    iget v9, v6, Landroidx/media3/extractor/mp4/Track;->type:I

    invoke-static {v9, v2, v8}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatGaplessInfo(ILandroidx/media3/extractor/GaplessInfoHolder;Landroidx/media3/common/Format$Builder;)V

    .line 799
    iget v9, v6, Landroidx/media3/extractor/mp4/Track;->type:I

    iget-object v15, v6, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;

    iget-object v15, v15, Landroidx/media3/common/Format;->metadata:Landroidx/media3/common/Metadata;

    move-object/from16 p1, v2

    filled-new-array {v13, v14}, [Landroidx/media3/common/Metadata;

    move-result-object v2

    invoke-static {v9, v12, v8, v15, v2}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatMetadata(ILandroidx/media3/common/Metadata;Landroidx/media3/common/Format$Builder;Landroidx/media3/common/Metadata;[Landroidx/media3/common/Metadata;)V

    .line 806
    new-instance v2, Landroidx/media3/extractor/mp4/FragmentedMp4Extractor$TrackBundle;

    iget v9, v6, Landroidx/media3/extractor/mp4/Track;->id:I

    .line 810
    invoke-direct {v0, v11, v9}, Landroidx/media3/extractor/mp4/FragmentedMp4Extractor;->getDefaultSampleValues(Landroid/util/SparseArray;I)Landroidx/media3/extractor/mp4/DefaultSampleValues;
    ...
    invoke-direct {v2, v7, v5, v9, v8}, Landroidx/media3/extractor/mp4/FragmentedMp4Extractor$TrackBundle;-><init>(Landroidx/media3/extractor/TrackOutput;Landroidx/media3/extractor/mp4/TrackSampleTable;Landroidx/media3/extractor/mp4/DefaultSampleValues;Landroidx/media3/common/Format;)V
    ...
    iget-wide v5, v6, Landroidx/media3/extractor/mp4/Track;->durationUs:J

    invoke-static {v7, v8, v5, v6}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v5

    iput-wide v5, v0, Landroidx/media3/extractor/mp4/FragmentedMp4Extractor;->durationUs:J
