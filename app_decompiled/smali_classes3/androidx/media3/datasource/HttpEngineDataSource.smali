...
.method constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lcom/google/common/base/Predicate;Z)V
    ...
    invoke-static {p1}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline4;->m(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {v0, v1, v2, p2}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline5;->m(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 729
    invoke-static {p2, v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline6;->m(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 730
    invoke-static {p2, v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline7;->m(Landroid/net/http/UrlRequest$Builder;Z)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 743
    invoke-static {p2, v3, v2}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline8;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v1, v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline8;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline9;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0, p1}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline10;->m(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)Landroid/net/http/UrlRequest$Builder;
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-static {p1}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline11;->m(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    .line 928
    invoke-static {p0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline2;->m(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p0

    invoke-static {p0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline3;->m(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline2;->m(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline12;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    .line 432
    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline1;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline13;->m(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    invoke-static {v4}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline12;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 526
    invoke-static {v0}, Landroidx/media3/datasource/HttpEngineDataSource$$ExternalSyntheticApiModelOutline14;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
