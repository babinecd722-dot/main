...
# direct methods
.method constructor <init>(ZLio/ktor/client/plugins/logging/LogLevel;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
...
.method public final invoke(Lio/ktor/client/plugins/logging/ReceiveHook$Context;Lio/ktor/client/call/HttpClientCall;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1, v2, p3}, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;-><init>(ZLio/ktor/client/plugins/logging/LogLevel;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {v0, p1}, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->invoke(Lio/ktor/client/plugins/logging/ReceiveHook$Context;Lio/ktor/client/call/HttpClientCall;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 625
    iget v1, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->label:I
    ...
    iget-object v3, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$0:Ljava/lang/Object;
    ...
    :cond_2
    iget-object v1, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$0:Ljava/lang/Object;
    ...
    iget-object p1, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$0:Ljava/lang/Object;
    ...
    .line 626
    iget-boolean v5, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->$okHttpFormat:Z
    ...
    :cond_5
    :try_start_1
    iput-object v1, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$0:Ljava/lang/Object;

    iput v4, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->label:I

    invoke-virtual {p1, p0}, Lio/ktor/client/plugins/logging/ReceiveHook$Context;->proceed(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 637
    iget-object v6, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->$level:Lio/ktor/client/plugins/logging/LogLevel;

    invoke-virtual {v1}, Lio/ktor/client/call/HttpClientCall;->getRequest()Lio/ktor/client/request/HttpRequest;

    move-result-object v1

    invoke-static {v6, v4, v1, p1}, Lio/ktor/client/plugins/logging/LoggingKt;->access$Logging$lambda$18$logResponseException(Lio/ktor/client/plugins/logging/LogLevel;Ljava/lang/StringBuilder;Lio/ktor/client/request/HttpRequest;Ljava/lang/Throwable;)V
    ...
    iput-object p1, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$0:Ljava/lang/Object;

    iput-object v5, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$1:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->L$1:Ljava/lang/Object;

    iput v2, p0, Lio/ktor/client/plugins/logging/LoggingKt$Logging$2$4;->label:I
