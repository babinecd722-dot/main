...
# interfaces
.implements Lio/appmetrica/analytics/impl/H;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/appmetrica/analytics/impl/Hg;-><init>(Ljava/lang/String;Lio/appmetrica/analytics/impl/Ig;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lio/appmetrica/analytics/impl/Ig;)V
    .locals 0
    ...
    .line 4
    iput-object p2, p0, Lio/appmetrica/analytics/impl/Hg;->b:Lio/appmetrica/analytics/impl/Ig;
...
.method public final a(Landroid/content/Context;)Lio/appmetrica/analytics/coreapi/internal/identifiers/AdTrackingInfoResult;
    ...
    invoke-virtual {p0, p1, v0}, Lio/appmetrica/analytics/impl/Hg;->a(Landroid/content/Context;Lio/appmetrica/analytics/impl/Ui;)Lio/appmetrica/analytics/coreapi/internal/identifiers/AdTrackingInfoResult;
...
.method public final a(Landroid/content/Context;Lio/appmetrica/analytics/impl/Ui;)Lio/appmetrica/analytics/coreapi/internal/identifiers/AdTrackingInfoResult;
    .locals 9
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    check-cast v2, Lio/appmetrica/analytics/impl/bo;

    const/4 v4, 0x0

    .line 4
    iput v4, v2, Lio/appmetrica/analytics/impl/bo;->c:I
    ...
    :catch_0
    :goto_0
    invoke-virtual {v2}, Lio/appmetrica/analytics/impl/bo;->b()Z
    ...
    .line 7
    :try_start_0
    invoke-virtual {p0, p1}, Lio/appmetrica/analytics/impl/Hg;->b(Landroid/content/Context;)Lio/appmetrica/analytics/coreapi/internal/identifiers/AdTrackingInfoResult;
    ...
    iget-object v8, p0, Lio/appmetrica/analytics/impl/Hg;->a:Ljava/lang/String;
    ...
    check-cast v5, Lio/appmetrica/analytics/impl/bo;

    .line 34
    iget v5, v5, Lio/appmetrica/analytics/impl/bo;->b:I
...
.method public final b(Landroid/content/Context;)Lio/appmetrica/analytics/coreapi/internal/identifiers/AdTrackingInfoResult;
    ...
    .line 1
    const-string v0, "io.appmetrica.analytics.identifiers.internal.AdvIdentifiersProvider"
    ...
    .line 4
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Hg;->a:Ljava/lang/String;
    ...
    .line 5
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Hg;->b:Lio/appmetrica/analytics/impl/Ig;
    ...
    .line 8
    sget-object v2, Lio/appmetrica/analytics/impl/L5;->a:Ljava/util/Map;
