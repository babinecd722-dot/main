...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lio/appmetrica/analytics/impl/i4;)V
    .locals 0
    .param p1    # Landroid/content/Context;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2    # Lio/appmetrica/analytics/impl/i4;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Lio/appmetrica/analytics/impl/s0;->b:Lio/appmetrica/analytics/coreapi/internal/executors/IHandlerExecutor;
    ...
    iput-object p2, p0, Lio/appmetrica/analytics/impl/s0;->c:Lio/appmetrica/analytics/impl/v4;

    .line 11
    invoke-virtual {p0}, Lio/appmetrica/analytics/impl/s0;->f()Lio/appmetrica/analytics/coreapi/internal/executors/IHandlerExecutor;
    ...
    iput-object p2, p0, Lio/appmetrica/analytics/impl/s0;->d:Landroid/os/Handler;

    .line 12
    new-instance p2, Lio/appmetrica/analytics/impl/f2;

    invoke-direct {p2}, Lio/appmetrica/analytics/impl/f2;-><init>()V

    iput-object p2, p0, Lio/appmetrica/analytics/impl/s0;->e:Lio/appmetrica/analytics/impl/f2;
    ...
    iput-object p2, p0, Lio/appmetrica/analytics/impl/s0;->f:Lio/appmetrica/analytics/impl/Gb;
    ...
    new-instance p2, Lio/appmetrica/analytics/impl/s0$$ExternalSyntheticLambda0;

    invoke-direct {p2}, Lio/appmetrica/analytics/impl/s0$$ExternalSyntheticLambda0;-><init>()V

    invoke-interface {p1, p2}, Lio/appmetrica/analytics/coreapi/internal/executors/ICommonExecutor;->execute(Ljava/lang/Runnable;)V

    .line 18
    invoke-virtual {p0}, Lio/appmetrica/analytics/impl/s0;->a()Lio/appmetrica/analytics/impl/v4;
...
.method public static final e()V
    ...
    const-string v1, " type, Version 8.1.0, API Level "
    ...
    const-string v1, ", Dated 13.04.2026."
...
.method public final a()Lio/appmetrica/analytics/impl/v4;
    ...
    .line 1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/s0;->c:Lio/appmetrica/analytics/impl/v4;
...
.method public final declared-synchronized a(Lio/appmetrica/analytics/AppMetricaConfig;Lio/appmetrica/analytics/impl/ob;)V
    ...
    .line 5
    :cond_1
    iget-object p2, p0, Lio/appmetrica/analytics/impl/s0;->f:Lio/appmetrica/analytics/impl/Gb;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/s0;->f:Lio/appmetrica/analytics/impl/Gb;
    ...
    .line 12
    iget-object v1, p0, Lio/appmetrica/analytics/impl/s0;->a:Landroid/content/Context;

    invoke-virtual {v0, v1, p1, p2}, Lio/appmetrica/analytics/impl/Gb;->a(Landroid/content/Context;Lio/appmetrica/analytics/AppMetricaConfig;Lio/appmetrica/analytics/impl/ob;)V
    ...
    .line 15
    :cond_5
    iget-object p2, p0, Lio/appmetrica/analytics/impl/s0;->e:Lio/appmetrica/analytics/impl/f2;

    .line 16
    invoke-virtual {p2}, Lio/appmetrica/analytics/impl/f2;->c()V
    ...
    .line 18
    invoke-virtual {p2}, Lio/appmetrica/analytics/impl/f2;->b()V
    ...
    .line 19
    sput-boolean p1, Lio/appmetrica/analytics/impl/A0;->g:Z
    :try_end_0
...
.method public final b()Landroid/os/Handler;
    ...
    .line 1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/s0;->d:Landroid/os/Handler;
...
.method public final c()Lio/appmetrica/analytics/impl/f2;
    ...
    .line 1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/s0;->e:Lio/appmetrica/analytics/impl/f2;
...
.method public final f()Lio/appmetrica/analytics/coreapi/internal/executors/IHandlerExecutor;
    ...
    .line 1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/s0;->b:Lio/appmetrica/analytics/coreapi/internal/executors/IHandlerExecutor;
