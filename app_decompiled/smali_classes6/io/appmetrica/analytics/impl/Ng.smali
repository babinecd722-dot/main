...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v6}, Lio/appmetrica/analytics/impl/Ng;-><init>(Lio/appmetrica/analytics/impl/Xn;Lio/appmetrica/analytics/impl/Y;Lio/appmetrica/analytics/impl/x6;Lio/appmetrica/analytics/impl/Sl;Lio/appmetrica/analytics/impl/cf;Lio/appmetrica/analytics/impl/df;)V
...
.method public constructor <init>(Lio/appmetrica/analytics/impl/Xn;Lio/appmetrica/analytics/impl/Y;Lio/appmetrica/analytics/impl/x6;Lio/appmetrica/analytics/impl/Sl;Lio/appmetrica/analytics/impl/cf;Lio/appmetrica/analytics/impl/df;)V
    ...
    .line 3
    iput-object p1, p0, Lio/appmetrica/analytics/impl/Ng;->a:Lio/appmetrica/analytics/impl/Xn;

    .line 4
    iput-object p2, p0, Lio/appmetrica/analytics/impl/Ng;->b:Lio/appmetrica/analytics/impl/Y;

    .line 5
    iput-object p3, p0, Lio/appmetrica/analytics/impl/Ng;->c:Lio/appmetrica/analytics/impl/x6;

    .line 6
    iput-object p4, p0, Lio/appmetrica/analytics/impl/Ng;->d:Lio/appmetrica/analytics/impl/Sl;

    .line 7
    iput-object p5, p0, Lio/appmetrica/analytics/impl/Ng;->e:Lio/appmetrica/analytics/impl/cf;

    .line 8
    iput-object p6, p0, Lio/appmetrica/analytics/impl/Ng;->f:Lio/appmetrica/analytics/impl/df;
...
# virtual methods
.method public final a(Lio/appmetrica/analytics/impl/n6;)Lio/appmetrica/analytics/impl/Mg;
    .locals 0
    .param p1    # Lio/appmetrica/analytics/impl/n6;
...
.method public final a(Lio/appmetrica/analytics/impl/Mg;)Lio/appmetrica/analytics/impl/n6;
    .locals 3
    .param p1    # Lio/appmetrica/analytics/impl/Mg;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    .line 2
    iget-object v1, p1, Lio/appmetrica/analytics/impl/Mg;->a:Ljava/lang/String;

    iget-object v2, v0, Lio/appmetrica/analytics/impl/n6;->f:Ljava/lang/String;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->f:Ljava/lang/String;

    .line 3
    iget-object p1, p1, Lio/appmetrica/analytics/impl/Mg;->b:Lio/appmetrica/analytics/impl/io;
    ...
    .line 6
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Ng;->a:Lio/appmetrica/analytics/impl/Xn;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->a:Lio/appmetrica/analytics/impl/r6;
    ...
    .line 9
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Ng;->b:Lio/appmetrica/analytics/impl/Y;

    invoke-virtual {v2, v1}, Lio/appmetrica/analytics/impl/Y;->a(Lio/appmetrica/analytics/impl/X;)Lio/appmetrica/analytics/impl/h6;

    move-result-object v1

    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->b:Lio/appmetrica/analytics/impl/h6;
    ...
    .line 12
    iget-object v2, p0, Lio/appmetrica/analytics/impl/Ng;->d:Lio/appmetrica/analytics/impl/Sl;

    invoke-virtual {v2, v1}, Lio/appmetrica/analytics/impl/Sl;->a(Ljava/util/List;)[Lio/appmetrica/analytics/impl/p6;

    move-result-object v1

    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->e:[Lio/appmetrica/analytics/impl/p6;

    .line 14
    :cond_2
    iget-object v1, p1, Lio/appmetrica/analytics/impl/io;->g:Ljava/lang/String;

    iget-object v2, v0, Lio/appmetrica/analytics/impl/n6;->c:Ljava/lang/String;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->c:Ljava/lang/String;

    .line 15
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Ng;->c:Lio/appmetrica/analytics/impl/x6;
    ...
    iput v1, v0, Lio/appmetrica/analytics/impl/n6;->d:I
    ...
    .line 17
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Ng;->e:Lio/appmetrica/analytics/impl/cf;
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->i:[B
    ...
    iput-object v1, v0, Lio/appmetrica/analytics/impl/n6;->j:[B
    ...
    .line 23
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Ng;->f:Lio/appmetrica/analytics/impl/df;
    ...
    iput-object p1, v0, Lio/appmetrica/analytics/impl/n6;->k:[Lio/appmetrica/analytics/impl/j6;
...
.method public final bridge synthetic fromModel(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lio/appmetrica/analytics/impl/Ng;->a(Lio/appmetrica/analytics/impl/Mg;)Lio/appmetrica/analytics/impl/n6;
