...
# direct methods
.method public static synthetic $r8$lambda$Eq68W_TGVYAYKTJ3syywKNIg4mk(Lcom/google/firebase/firestore/util/AsyncQueue$DelayedTask;Lcom/google/firebase/firestore/util/AsyncQueue$DelayedTask;)I
    .locals 2
...
.method public static synthetic $r8$lambda$M-dibdImsJeiX08bsIpNG4eEPHI(Ljava/lang/Runnable;[Ljava/lang/Throwable;Ljava/util/concurrent/Semaphore;)V
    .locals 1
...
.method public static synthetic $r8$lambda$W72ljPf-RzmXDW5fK24c351JXCo(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    .locals 1
    ...
    new-instance v0, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda2;

    invoke-direct {v0, p2}, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda2;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public static synthetic $r8$lambda$Xkd4hSRTKI7VknSvlTCKWduPogs(Ljava/lang/Runnable;)Ljava/lang/Void;
    .locals 0
...
.method public static synthetic $r8$lambda$qfCo9Il-tk52ni5i-9twVWAG0n8(Lcom/google/firebase/firestore/util/AsyncQueue;Lcom/google/firebase/firestore/util/AsyncQueue$TimerId;)V
    .locals 3
    ...
    new-instance v1, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda0;-><init>()V
...
.method public static synthetic $r8$lambda$yOAZCH-Pb0zn55WvdAAimGmZs_U(Ljava/lang/Throwable;)V
    .locals 2
    ...
    const-string v1, "Firestore (26.1.1) ran out of memory. Check your queries to make sure they are not loading an excessive amount of data."
    ...
    const-string v1, "Internal error in Cloud Firestore (26.1.1)."
...
.method public static synthetic $r8$lambda$zugaEAe8Q0GtTQK1cv3VsRppmQ4(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    .locals 1
...
.method public static callTask(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p1, p0, v0}, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda6;-><init>(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public enqueue(Ljava/lang/Runnable;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 443
    new-instance v0, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda4;

    invoke-direct {v0, p1}, Lcom/google/firebase/firestore/util/AsyncQueue$$ExternalSyntheticLambda4;-><init>(Ljava/lang/Runnable;)V
