...
.method public prefetch(Landroid/net/Uri;Landroidx/browser/customtabs/PrefetchOptions;)V
    .locals 2
    .annotation build Landroidx/browser/customtabs/ExperimentalPrefetch;
    .end annotation

    .line 131
    invoke-virtual {p2}, Landroidx/browser/customtabs/PrefetchOptions;->toBundle()Landroid/os/Bundle;
    ...
    invoke-interface {v0, v1, p1, p2}, Landroid/support/customtabs/ICustomTabsService;->prefetch(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public prefetch(Ljava/util/List;Landroidx/browser/customtabs/PrefetchOptions;)V
    .locals 2
    .annotation build Landroidx/browser/customtabs/ExperimentalPrefetch;
    .end annotation
    ...
    invoke-interface {v0, v1, p1, p2}, Landroid/support/customtabs/ICustomTabsService;->prefetchWithMultipleUrls(Landroid/support/customtabs/ICustomTabsCallback;Ljava/util/List;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 195
    const-string/jumbo p1, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS_VIEW_IDS"

    invoke-virtual {v0, p1, p2}, Landroid/os/BaseBundle;->putIntArray(Ljava/lang/String;[I)V

    .line 196
    const-string/jumbo p1, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS_PENDINGINTENT"
