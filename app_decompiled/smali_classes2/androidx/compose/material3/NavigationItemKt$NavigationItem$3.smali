...
.method constructor <init>(ZLkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function2;Landroidx/compose/ui/text/TextStyle;Landroidx/compose/ui/graphics/Shape;FFFFFFLandroidx/compose/material3/NavigationItemColors;Landroidx/compose/ui/Modifier;ZLkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;ILandroidx/compose/foundation/interaction/MutableInteractionSource;II)V
    ...
    .line 0
    iput-boolean p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$selected:Z

    iput-object p2, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$onClick:Lkotlin/jvm/functions/Function0;

    iput-object p3, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$icon:Lkotlin/jvm/functions/Function2;

    iput-object p4, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$labelTextStyle:Landroidx/compose/ui/text/TextStyle;

    iput-object p5, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$indicatorShape:Landroidx/compose/ui/graphics/Shape;

    iput p6, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$indicatorWidth:F

    iput p7, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$indicatorHorizontalPadding:F

    iput p8, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$indicatorVerticalPadding:F

    iput p9, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$indicatorToLabelVerticalPadding:F

    iput p10, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$startIconToLabelHorizontalPadding:F

    iput p11, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$topIconItemVerticalPadding:F

    iput-object p12, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$colors:Landroidx/compose/material3/NavigationItemColors;

    iput-object p13, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$modifier:Landroidx/compose/ui/Modifier;

    iput-boolean p14, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$enabled:Z

    iput-object p15, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$label:Lkotlin/jvm/functions/Function2;

    move-object/from16 p1, p16

    iput-object p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$badge:Lkotlin/jvm/functions/Function2;

    move/from16 p1, p17

    iput p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$iconPosition:I

    move-object/from16 p1, p18

    iput-object p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    move/from16 p1, p19

    iput p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$$changed:I

    move/from16 p1, p20

    iput p1, p0, Landroidx/compose/material3/NavigationItemKt$NavigationItem$3;->$$changed1:I
