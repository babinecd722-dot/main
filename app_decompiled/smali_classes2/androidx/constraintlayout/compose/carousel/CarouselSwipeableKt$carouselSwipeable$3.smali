...
# direct methods
.method constructor <init>(Ljava/util/Map;Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Landroidx/constraintlayout/compose/carousel/ResistanceConfig;Lkotlin/jvm/functions/Function2;FLandroidx/compose/foundation/gestures/Orientation;ZLandroidx/compose/foundation/interaction/MutableInteractionSource;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final invoke(Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/Modifier;
    ...
    iget-object v3, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$anchors:Ljava/util/Map;
    ...
    invoke-virtual {v2, v3}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->ensureInit$constraintlayout_compose_release(Ljava/util/Map;)V

    .line 574
    iget-object v2, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$anchors:Ljava/util/Map;

    iget-object v11, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$state:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;
    ...
    iget-object v4, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$resistance:Landroidx/constraintlayout/compose/carousel/ResistanceConfig;
    ...
    iget-object v4, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$thresholds:Lkotlin/jvm/functions/Function2;
    ...
    iget v4, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$velocityThreshold:F
    ...
    iget-object v4, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$state:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;
    ...
    iget-object v6, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$resistance:Landroidx/constraintlayout/compose/carousel/ResistanceConfig;

    iget-object v8, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$thresholds:Lkotlin/jvm/functions/Function2;

    iget v9, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$velocityThreshold:F
    ...
    .line 574
    :cond_1
    new-instance v3, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3$3$1;

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3$3$1;-><init>(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Ljava/util/Map;Landroidx/constraintlayout/compose/carousel/ResistanceConfig;Landroidx/compose/ui/unit/Density;Lkotlin/jvm/functions/Function2;FLkotlin/coroutines/Continuation;)V
    ...
    .line 588
    iget-object v14, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$orientation:Landroidx/compose/foundation/gestures/Orientation;

    .line 589
    iget-boolean v15, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$enabled:Z

    .line 591
    iget-object v2, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    .line 593
    iget-object v3, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$state:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;
    ...
    invoke-direct {v5, v4, v3}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3$4$1;-><init>(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Lkotlin/coroutines/Continuation;)V
    ...
    .line 590
    iget-boolean v3, v0, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableKt$carouselSwipeable$3;->$reverseDirection:Z
