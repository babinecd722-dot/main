...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$motionScene:Landroidx/constraintlayout/compose/MotionScene;

    iget-object v2, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$constraintSetName:Ljava/lang/String;

    iget-object v3, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$animationSpec:Landroidx/compose/animation/core/AnimationSpec;

    iget-object v4, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$modifier:Landroidx/compose/ui/Modifier;

    iget-object v5, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$finishedAnimationListener:Lkotlin/jvm/functions/Function0;

    iget v6, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$debugFlags:I

    iget v7, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$optimizationLevel:I

    iget-object v8, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$contentTracker:Landroidx/compose/runtime/MutableState;

    iget-object v9, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$compositionSource:Landroidx/compose/ui/node/Ref;

    iget-object v10, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$invalidationStrategy:Landroidx/constraintlayout/compose/InvalidationStrategy;

    iget-object v11, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$content:Lkotlin/jvm/functions/Function3;

    iget v12, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$$changed:I
    ...
    iget v12, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$$changed1:I

    invoke-static {v12}, Landroidx/compose/runtime/RecomposeScopeImplKt;->updateChangedFlags(I)I

    move-result v14

    iget v15, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$4;->$$default:I
