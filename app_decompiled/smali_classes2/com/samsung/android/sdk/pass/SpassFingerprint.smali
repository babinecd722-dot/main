...
.method public cancelIdentify()V
    ...
    iget-object v1, p0, Lcom/samsung/android/sdk/pass/SpassFingerprint;->t:Lcom/samsung/android/sdk/pass/SpassFingerprint$b;

    if-nez v1, :cond_1

    iget-object v1, p0, Lcom/samsung/android/sdk/pass/SpassFingerprint;->s:Landroid/app/Dialog;
...
.method public setIntendedFingerprintIndex(Ljava/util/ArrayList;)V
    ...
    const-string/jumbo v0, "requestedIndex is null. Identify is carried out for all indexes."
...
.method public startIdentify(Lcom/samsung/android/sdk/pass/SpassFingerprint$IdentifyListener;)V
    ...
    const-string/jumbo v1, "startIdentify : failed, "
...
.method public startIdentifyWithDialog(Landroid/content/Context;Lcom/samsung/android/sdk/pass/SpassFingerprint$IdentifyListener;Z)V
    ...
    invoke-virtual {v4, v5, p3}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v4, p3, v5}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, p3, v5}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    if-eqz v0, :cond_3

    const-string/jumbo p3, "request_template_index_list"

    invoke-virtual {v4, p3, v0}, Landroid/os/BaseBundle;->putIntArray(Ljava/lang/String;[I)V
