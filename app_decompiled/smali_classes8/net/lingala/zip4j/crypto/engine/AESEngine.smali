...
.method private generateWorkingKey([B)[[I
    ...
    iput v6, v0, Lnet/lingala/zip4j/crypto/engine/AESEngine;->rounds:I

    .line 51
    iget v6, v0, Lnet/lingala/zip4j/crypto/engine/AESEngine;->rounds:I
    ...
    .line 62
    :cond_1
    iget v11, v0, Lnet/lingala/zip4j/crypto/engine/AESEngine;->rounds:I
    ...
    .line 66
    invoke-direct {v0, v12, v4}, Lnet/lingala/zip4j/crypto/engine/AESEngine;->shift(II)I

    move-result v13

    invoke-direct {v0, v13}, Lnet/lingala/zip4j/crypto/engine/AESEngine;->subWord(I)I

    move-result v13

    sget-object v14, Lnet/lingala/zip4j/crypto/engine/AESEngine;->rcon:[I
    ...
    .line 68
    invoke-direct {v0, v12}, Lnet/lingala/zip4j/crypto/engine/AESEngine;->subWord(I)I
    ...
    const-string v4, "invalid key length (not 128/192/256)"
