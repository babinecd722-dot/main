...
.method static decodeStream(Lokio/Source;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v8, v6}, Lcom/squareup/picasso/MarkableInputStream;-><init>(Ljava/io/InputStream;)V
    ...
    .line 150
    invoke-virtual {v8, v2}, Lcom/squareup/picasso/MarkableInputStream;->allowMarksToExpire(Z)V

    .line 151
    const/16 v2, 0x400

    invoke-virtual {v8, v2}, Lcom/squareup/picasso/MarkableInputStream;->savePosition(I)J
    ...
    invoke-static {v2, v11, v4, p1}, Lcom/squareup/picasso/RequestHandler;->calculateInSampleSize(IILandroid/graphics/BitmapFactory$Options;Lcom/squareup/picasso/Request;)V

    .line 155
    invoke-virtual {v8, v9, v10}, Lcom/squareup/picasso/MarkableInputStream;->reset(J)V
    ...
    invoke-static {v6, v2, v7, v4}, Landroid/graphics/BitmapFactory;->decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v7, v8, v4, p1}, Lcom/squareup/picasso/RequestHandler;->calculateInSampleSize(IILandroid/graphics/BitmapFactory$Options;Lcom/squareup/picasso/Request;)V
