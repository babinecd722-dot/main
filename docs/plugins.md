...
| Открыть | Это ваш плагин, он открывается в «Оформлении» |
...
Публикуют из «Оформления» плагина. Над названием там строка «Баннер»: по нажатию открывается
галерея, выбранное фото кадрируется в квадрат со скруглёнными углами (двигайте и
масштабируйте), и именно оно уходит в Маркет иконкой плагина. Ниже блок «Маркет» с
«Редактором» и кнопкой «Опубликовать».
...
причиной или снята. Нажатие открывает «Оформление» вашей рабочей копии: там меняются описание и
версия, «Редактор» открывает код, «Сохранить» сохраняет его, а «Опубликовать» отправляет
обновление на модерацию. Если на этом устройстве копии нет, приложение делает её из
опубликованной версии.

### AorusAI в редакторе

В редакторе кода справа вверху три кнопки: «Сохранить», «AI» и «⋯». «AI» открывает поле
запроса: опишите, что должен делать плагин, или что изменить в открытом коде, и отправьте.
Текущий код уходит вместе с запросом как контекст. AorusAI возвращает только код, и он сразу
печатается в редакторе, строка за строкой. Ничего не сохраняется, пока вы не нажмёте
«Сохранить». Если у плагина ещё стандартное название, он получает название и описание из
ответа. Запрос — от 8 до 4000 символов.
