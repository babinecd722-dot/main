...
Core Animation в отдельном окне поверх всех окон приложения, клавиатуры тоже. Это окно не
перехватывает касания: сквозь эффект можно продолжать пользоваться приложением.
