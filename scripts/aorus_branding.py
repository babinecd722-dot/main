...
def patch_incoming_message_hook(tg: Path) -> None:
    ...
    prefilter_code = (
        ...
        "                    let moneySignals = [\"₽\", \"$\", \"€\", \"руб\", \"доллар\", \"оплата\", \"выплата\", \"прибыль\", \"процент\", \"x2\", \"x3\"]\n"
