...
def patch_incoming_message_hook(tg: Path) -> None:
    ...
    prefilter_code = (
        ...
        "                        if aorusShouldHideIncomingSpam(identity: identity, text: storeMsg.text) { return nil }\n"
        "                    }\n"
