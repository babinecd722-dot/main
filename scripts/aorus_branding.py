...
def patch_profile_report_button(tg: Path) -> None:
    ...
    item = (
        ...
        "                                    return\n"
        "                                }\n"
        "                                let reportSubject = ReportContentSubject.peer(strongSelf.peerId, sourceMessageId: strongSelf.sourceMessageId)\n"
        "                                strongSelf.context.sharedContext.makeContentReportScreen(context: strongSelf.context, subject: reportSubject, forceDark: false, present: { [weak self] controller in\n"
