...
def patch_status_edit_delete_icons(tg: Path) -> None:
    ...
    new_date = (
        ...
        "                    if arguments.isDeleted || arguments.edited { aorusDateString.append(NSAttributedString(string: \" \", attributes: [NSAttributedString.Key.font: dateFont, NSAttributedString.Key.foregroundColor: dateColor])) }\n"
