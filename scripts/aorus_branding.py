...
def patch_incoming_message_hook(tg: Path) -> None:
    ...
    hook_code = (
        ...
        "                    }\n"
        "                    // Anti-spam is a private-DM-from-a-stranger problem: mark whether this\n"
        "                    // message is eligible so the main-app handler never auto-blocks a person\n"
        "                    // for group/channel chatter or blocks someone already in your contacts.\n"
