...
final class ActivateConfirmController: UIViewController {
    ...
    private func renderPrompt() {
        ...
        addSpacing(20)
        addContent(centeredView(badgePill(SubL10n.isRU ? "\u{2736} AorusGram Premium \u{2736}" : "\u{2736} AorusGram Premium \u{2736}",
                                          color: Self.accent)))
        addSpacing(16)
        ...
        // Entrance: pop in from below with spring
    ...
    private func keyCard() -> UIView {
        ...
        if #available(iOS 13.0, *) {
            ...
            copy.setTitle("\u{2398}", for: .normal)
        }
    ...
    private func successCard(response: LicenseResponse, days: Int) -> UIView {
        ...
        if let until = response.activeUntil {
            ...
            dateLbl.text = SubL10n.isRU ? "\u{430}\u{43a}\u{442}\u{438}\u{432}\u{43d}\u{430} \u{434}\u{43e} \(s)" : "active until \(s)"
        }
